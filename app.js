const shopcart = document.querySelector(".shopcart_column");
const cartDOM = document.querySelector(".cart");
const cartContent = document.querySelector(".shopcart__container");
const cartTotal = document.querySelector(".shopcart__total");
